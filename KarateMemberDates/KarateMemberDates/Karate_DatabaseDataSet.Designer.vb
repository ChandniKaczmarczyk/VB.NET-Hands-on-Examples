...
Partial Public Class Karate_DatabaseDataSet
    ...
    Partial Public Class PaymentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddPaymentsRow(ByVal ID As Integer, ByVal Member_Id As Integer, ByVal Payment_Date As Date, ByVal Amount As String) As PaymentsRow
            Dim rowPaymentsRow As PaymentsRow = CType(Me.NewRow,PaymentsRow)
            Dim columnValuesArray() As Object = New Object() {ID, Member_Id, Payment_Date, Amount}
    ...
    Partial Public Class PaymentsRow
        ...
        Public Property Member_Id() As Integer
            Get
                Try 
                    Return CType(Me(Me.tablePayments.Member_IdColumn),Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Function IsMember_IdNull() As Boolean
            Return Me.IsNull(Me.tablePayments.Member_IdColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetMember_IdNull()
            Me(Me.tablePayments.Member_IdColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace Karate_DatabaseDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Members` WHERE ((`ID` = ?) AND ((? = 1 AND `Phone` IS NULL) OR (`Pho"& _ 
                "ne` = ?)) AND ((? = 1 AND `Date_Joined` IS NULL) OR (`Date_Joined` = ?)))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Members` SET `Last_Name` = ?, `First_Name` = ?, `Phone` = ?, `Date_Joined"& _ 
                "` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ("& _ 
                "(? = 1 AND `Date_Joined` IS NULL) OR (`Date_Joined` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.KarateMemberDates.My.MySettings.Default.Karate_DatabaseConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT        ID, Last_Name, First_Name, Phone, Date_Joined" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            Memb" & _
                "ers" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (Date_Joined < ?)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Date_Joined", Global.System.Data.OleDb.OleDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "Date_Joined", Global.System.Data.DataRowVersion.Current, False, Nothing))
        End Sub
        ...
        Public Overridable Overloads Function FillByDate(ByVal dataTable As Karate_DatabaseDataSet.MembersDataTable, ByVal Date_Joined As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Phone As String, ByVal Original_Date_Joined As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Last_Name As String, ByVal First_Name As String, ByVal Phone As String, ByVal Date_Joined As Global.System.Nullable(Of Date), ByVal Original_ID As Integer, ByVal Original_Phone As String, ByVal Original_Date_Joined As Global.System.Nullable(Of Date)) As Integer
            If (Last_Name Is Nothing) Then
            ...
            If (Original_Date_Joined.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_Date_Joined.Value,Date)
            Else
    ...
    Partial Public Class PaymentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Payments` WHERE ((`ID` = ?) AND ((? = 1 AND `Member_Id` IS NULL) OR "& _ 
            ...
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Payments` (`ID`, `Member_Id`, `Payment_Date`, `Amount`) VALUES (?, ?"& _ 
                ", ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Payments` SET `ID` = ?, `Member_Id` = ?, `Payment_Date` = ?, `Amount` = ?"& _ 
                " WHERE ((`ID` = ?) AND ((? = 1 AND `Member_Id` IS NULL) OR (`Member_Id` = ?)) AN"& _ 
                "D ((? = 1 AND `Payment_Date` IS NULL) OR (`Payment_Date` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT ID, Member_Id, Payment_Date, Amount FROM Payments"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As Karate_DatabaseDataSet.PaymentsDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As Karate_DatabaseDataSet.PaymentsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Karate_DatabaseDataSet.PaymentsDataTable = New Karate_DatabaseDataSet.PaymentsDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Karate_DatabaseDataSet.PaymentsDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Member_Id As Global.System.Nullable(Of Integer), ByVal Original_Payment_Date As Global.System.Nullable(Of Date)) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_ID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal Member_Id As Global.System.Nullable(Of Integer), ByVal Payment_Date As Global.System.Nullable(Of Date), ByVal Amount As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal ID As Integer, ByVal Member_Id As Global.System.Nullable(Of Integer), ByVal Payment_Date As Global.System.Nullable(Of Date), ByVal Amount As String, ByVal Original_ID As Integer, ByVal Original_Member_Id As Global.System.Nullable(Of Integer), ByVal Original_Payment_Date As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_Member_Id.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_Member_Id.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(6).Value = Global.System.DBNull.Value
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Member_Id As Global.System.Nullable(Of Integer), ByVal Payment_Date As Global.System.Nullable(Of Date), ByVal Amount As String, ByVal Original_ID As Integer, ByVal Original_Member_Id As Global.System.Nullable(Of Integer), ByVal Original_Payment_Date As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(Original_ID, Member_Id, Payment_Date, Amount, Original_ID, Original_Member_Id, Original_Payment_Date)
        End Function
    End Class
